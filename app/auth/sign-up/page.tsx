...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background p-6 lotus-gradient">
      ...
      <div className="relative w-full max-w-sm mx-auto text-center">
        ...
        <div className="flex flex-col items-center justify-center mb-10">
          <Link href="/" className="flex flex-col items-center">
            <div className="w-20 h-20 rounded-3xl overflow-hidden lotus-glow mb-6">
              <Image
                src="/lotus-icon.jpg"
                alt="lotus"
                width={80}
            ...
            <h1 className="text-3xl font-serif font-normal tracking-wide mb-2 text-gradient-lotus">
              lotus
            </h1>
          </Link>
        ...
        <div className="space-y-6">
          ...
          <Button
            ...
            className="w-full h-14 rounded-2xl bg-card/50 border-border/30 backdrop-blur-xl font-light tracking-wide hover:bg-card/70 transition-all duration-300"
          >
            {googleLoading ? (
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-background px-4 text-muted-foreground font-light tracking-wide">or</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            <Input
              ...
              placeholder="email"
              className="h-14 rounded-2xl bg-card/50 border-border/30 backdrop-blur-xl font-light tracking-wide text-center placeholder:text-muted-foreground/50"
              disabled={loading}
            />
            <Input
              type="password"
