...
/**
 * Fetches a published site's HTML by subdomain/slug and returns an HTML response.
 * Shared by both the subdomain serve route (xyz.lotus.app) and the
 * path-based fallback route (/s/xyz) so they always behave identically.
 */
export async function servePublishedSite(subdomain: string | undefined | null) {
  if (!subdomain) {
...
<body>
  <div class="container">
    ...
    <a href="/">create your own with lotus</a>
  </div>
</body>
</html>`,
    {
